    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartProvider.useEffect": ()=>{
            ...
            setCartCount(cart.reduce({
                "CartProvider.useEffect": (total, item)=>total + item.quantity
...
_s(CartProvider, "SbyDSR8CKZNPZTih+UJyEj4eO7M=");
_c = CartProvider;
function useCart() {
    _s1();
    // Get the context
...
_s(Navbar, "CaocStNNRsm+kALPnCuS83cNb/A=", false, function() {
    return [
...
//# sourceMappingURL=src_c0a2b811._.js.map
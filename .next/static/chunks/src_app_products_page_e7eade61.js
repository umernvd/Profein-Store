                ...
                "ProductsPage.useEffect.fetchProducts": async ()=>{
                    try {
                        ...
                        const formattedProducts = data.map({
                            "ProductsPage.useEffect.fetchProducts.formattedProducts": (item)=>({
                                    id: item.id,
                                    name: item.name,
                                    price: item.price,
                        ...
                        }["ProductsPage.useEffect.fetchProducts.formattedProducts"]);
...
_s(ProductsPage, "F92iyYH+xQzfgbIhLZSJCxxFwPA=", false, function() {
    return [
...
//# sourceMappingURL=src_app_products_page_e7eade61.js.map